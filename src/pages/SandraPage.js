...
function SandraPage() {
  const sandra = artistsData.find((artist) => artist.name === "Sandra");
            ...
            <div className="artist_page_item reverse">
              <div className="artist_page_info animate__animated animate__slideInRight">
                <Atropos shadow={false} highlight={false}>
                  <h2 className="title_h2">{sandra.name}</h2>
                </Atropos>
                <p className="text1">{sandra.description1}</p>
                <p className="text2">{sandra.description2}</p>
                <Link to={"/application"}>
              ...
              <div className="artist_photo animate__animated animate__slideInLeft">
                <img src={sandra_img} alt="nick_master" />
              </div>
            </div>
          </div>
